...
export type CancellationBadgeStatus = TripCancellationStatus | CancellationStatus | 'Requested'
...
const statusStyles: Record<string, { label: string; base: string; emphasis: string }> = {
  None: {
    label: 'Active',
...
export function CancellationBadge({ cancellationStatus, emphasis = false, size = 'md' }: CancellationBadgeProps) {
