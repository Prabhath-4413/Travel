      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {[...Array(12)].map((_, i) => (
          <FloatingParticle
            ...
            color={['white/10', 'blue-500/20', 'purple-500/20', 'pink-500/20'][Math.floor(Math.random() * 4)]}
          />
        ))}
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div>
            ...
            >
              <p>
                SuiteSavvy is your ultimate travel companion, dedicated to transforming the way you explore the world. We believe that travel should be effortless, memorable, and enriching for everyone.
              </p>
              <p>
                With over a decade of experience in the travel industry, our team has crafted a platform that combines cutting-edge technology with personalized service to deliver unforgettable experiences.
              </p>
              <p>
                From discovering hidden gems to booking seamless accommodations, we're committed to making your journey extraordinary.
              </p>
            </motion.div>
    ...
    >
      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex items-start gap-2 mb-4 text-white/60 text-sm">
          ...
          <span>{destination.city ? `${destination.city}, ${destination.country}` : (destination.country || 'Popular destination')}</span>
        </div>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            Explore breathtaking locations handpicked for unforgettable experiences
          </p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {loading ? (
            Array.from({ length: 6 }).map((_, i) => <DestinationSkeleton key={i} />)
...
const DestinationsSection = () => {
  ...
  return (
    <section 
      ...
      className="relative py-20 md:py-32 px-6 overflow-hidden"
      style={{
        backgroundImage: 'url("https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=2400&h=1400&fit=crop")',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-3xl mx-auto leading-relaxed">
            Explore India’s best beaches, mountains, and city escapes carefully curated for unforgettable trips. Every place is handpicked for great value, authentic experiences, and stunning views. Find your next adventure and book it in minutes.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {loading ? (
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="col-span-full text-center py-12">
              <p className="text-white/60 text-lg">No destinations found matching your filters</p>
            </motion.div>
          )}
        </div>
      </div>
...
const CTASection = ({ onExploreClick }: any) => {
  ...
  return (
    <section 
      ...
      className="relative py-20 md:py-32 px-6 overflow-hidden"
      style={{
        backgroundImage: 'url("https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=2000&h=1200&fit=crop")',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundAttachment: 'scroll'
      }}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            >
              Create your account and start planning your next adventure today. Instant bookings, secure payments, and 24/7 support await you.
            </motion.p>
...
const FooterSection = () => {
  ...
  return (
    <footer ref={footerRef} className="relative bg-[#0a0f0c] border-t border-white/10 overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl" />
      </div>
        ...
        >
          ...
          >
            <p className="text-white/70 mb-6 leading-relaxed">
              Discover and book amazing travel experiences across India. From beaches to mountains, your next adventure awaits.
            </p>

            <div className="space-y-3">
              <motion.div whileHover={{ x: 5 }} className="flex items-center gap-3 text-white/70 hover:text-white transition-colors cursor-pointer">
          ...
          {Object.entries(footerLinks).map(([key, links]) => (
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-lg font-bold text-white mb-6 capitalize">{key}</h3>
              {links.map((link) => (
                <motion.a
                  key={link.label}
                  href={link.href}
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            <div>
              ...
              <p className="text-white/70 text-sm mb-4">Get the latest travel deals and destination guides</p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-white/60 text-sm">
            ...
            <div className="flex items-center gap-6">
              <motion.a href="#" whileHover={{ color: '#fff' }} className="text-white/60 hover:text-white transition-colors">
                Privacy Policy
              </motion.a>
