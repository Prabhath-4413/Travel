...
export const getPackages = async (): Promise<TravelPackage[]> => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Failed to fetch travel packages."),
    );
  }
};
...
export const getPackageById = async (id: number): Promise<TravelPackage> => {
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Failed to fetch the travel package."),
    );
  }
};

export const createPackage = async (
  data: CreateTravelPackageRequest,
  ...
  try {
    ...
    throw new Error(
      extractErrorMessage(error, "Failed to create the travel package."),
    );
  }
};
